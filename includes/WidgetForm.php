...
class WidgetForm extends CWidgetForm {
	...
	public function addFields(): self {
		return $this
			...
			->addField((new CWidgetFieldCheckBox('aggregate_similar', _('Summarize similar rows (group & count)')))->setDefault(0))
			->addField(new CWidgetFieldTextBox('aggregate_columns', _('Group-by columns (comma-separated, optional)')))
			...
			->addField((new CWidgetFieldTextBox('history_values_limit', _('History values to merge')))->setDefault('1'))
